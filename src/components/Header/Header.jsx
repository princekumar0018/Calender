        ...
        <Select
          ...
          render={(click) => (
            <div>
              ...
              <li onClick={() => click("week")} className="mui-select-item">
                Week
              </li>
        ...
        <li>
          {authState.auth ? (
            <>
              <Avatar
                onClick={() =>
                  setOpenAuthPopup(openAuthPopup === "auth" ? "" : "auth")
                }
                className="w-10 h-10 rounded-full cursor-pointer"
                src={authState.auth?.avatar}
                username={authState.auth.firstName}
              />
              <Popup
                backdropClass="!bg-transparent"
                isWithBackdrop={true}
                onClose={() => setOpenAuthPopup("")}
                isOpen={openAuthPopup}
                className="right-0 shadow-xl user-menu-popup"
              >
