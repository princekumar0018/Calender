...
const Login = ({ setTab }) => {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      status.message =
        ex?.response?.data?.message || ex?.message || "Internal error";
    } finally {
  ...
  return (
    <div className="login-form">
      ...
      <p className="text-sm text-gray-600 my-4">
        Preserve your event and get notification, you need to login{" "}
      </p>
      ...
      <form onSubmit={onSubmit} className="">
        ...
        <div className="flex items-center gap-x-1 text-gray-600 text-sm mt-4">
          ...
          <a href="#" onClick={() => setTab(2)} className="text-blue-500">
            Registration
          </a>
        </div>
      </form>
